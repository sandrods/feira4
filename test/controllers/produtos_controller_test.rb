...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { colecao_id: @produto.colecao_id, fornecedor_id: @produto.fornecedor_id, linha_id: @produto.linha_id, ref: @produto.ref, tipo_id: @produto.tipo_id }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { colecao_id: @produto.colecao_id, fornecedor_id: @produto.fornecedor_id, linha_id: @produto.linha_id, ref: @produto.ref, tipo_id: @produto.tipo_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
